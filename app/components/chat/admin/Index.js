...
import Conversations from './chats/Index'

const Index = ({ setIsChatOpen, usersList, setActiveChatUser, activeChatUser, typingUsers, messages, newMessage, setNewMessage, sendMessage, messagesEndRef }) => {
    return (
        <>
            <div className="fixed inset-0 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex z-50">
                ...
                <div className="bg-gradient-to-b from-slate-800 to-slate-900 w-80 border-r border-purple-500/20 shadow-2xl">
                    ...
                    {/* Users List */}
                    <Conversations typingUsers={typingUsers} usersList={usersList} setActiveChatUser={setActiveChatUser} activeChatUser={activeChatUser} messages={messages} />
                </div>
